...
export function CharacterTable({ levelSet, isActive }: CharacterTableProps) {
  ...
  const unlockedCharacters = new Set(getUnlockedCharacters().map(char => char.id));
  ...
  return (
    <div style={{ padding: '1rem' }}>
      <h3 style={{ marginBottom: '1rem', color: '#e2e8f0', textShadow: '2px 2px 4px rgba(0, 0, 0, 0.3)' }}>
            ...
            switch (characterState) {
              case 'current':
                return {
                  ...
                  background: 'linear-gradient(135deg, rgba(99, 179, 237, 0.2) 0%, rgba(45, 55, 72, 0.8) 100%)',
                  color: '#63b3ed',
