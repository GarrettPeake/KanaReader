...
export const JLPT_LEVEL_SETS: LevelSet[] = [
  {
    ...
    explanation: 'Essential kanji for JLPT N5 level. These are the most basic kanji you should learn first.',
  ...
  // N4 Level Sets (2 sets)
  {
    ...
    explanation: 'First set of JLPT N4 kanji. Building on N5 foundation with more complex characters.',
  ...
  },
  {
    ...
    explanation: 'Second set of JLPT N4 kanji, completing the N4 level requirements.',
  ...
  // N3 Level Sets (4 sets)
  {
    ...
    explanation: 'First set of JLPT N3 kanji. Intermediate level characters for everyday communication.',
  ...
  },
  {
    ...
    explanation: 'Second set of JLPT N3 kanji, building intermediate reading comprehension.',
  ...
  },
  {
    ...
    explanation: 'Third set of JLPT N3 kanji, expanding vocabulary for practical situations.',
  ...
  },
  {
    ...
    explanation: 'Final set of JLPT N3 kanji, completing intermediate level requirements.',
  ...
  // N2 Level Sets (4 sets)
  {
    ...
    explanation: 'First set of JLPT N2 kanji. Upper-intermediate level for advanced communication.',
  ...
  },
  {
    ...
    explanation: 'Second set of JLPT N2 kanji, advancing toward professional-level literacy.',
  ...
  },
  {
    ...
    explanation: 'Third set of JLPT N2 kanji, building advanced reading skills.',
  ...
  },
  {
    ...
    explanation: 'Final set of JLPT N2 kanji, completing upper-intermediate requirements.',
  ...
  // N1 Level Sets (12 sets)
  {
    ...
    explanation: 'First set of JLPT N1 kanji. Advanced level for native-like proficiency.',
  ...
  },
  {
    ...
    explanation: 'Third set of JLPT N1 kanji, building sophisticated vocabulary.',
  ...
  },
  {
    ...
    explanation: 'Fourth set of JLPT N1 kanji, expanding academic and literary vocabulary.',
  ...
  },
  {
    ...
    explanation: 'Fifth set of JLPT N1 kanji, developing mastery of complex characters.',
  ...
  },
  {
    ...
    explanation: 'Sixth set of JLPT N1 kanji, approaching native-level literacy.',
  ...
  },
  {
    ...
    explanation: 'Seventh set of JLPT N1 kanji, mastering specialized vocabulary.',
  ...
  },
  {
    ...
    explanation: 'Eighth set of JLPT N1 kanji, building comprehensive literacy.',
  ...
  },
  {
    ...
    explanation: 'Ninth set of JLPT N1 kanji, advanced literary and academic terms.',
  ...
  },
  {
    ...
    explanation: 'Eleventh set of JLPT N1 kanji, mastering the most complex characters.',
  ...
  },
  {
    ...
    explanation: 'Final set of JLPT N1 kanji, completing mastery of all Jōyō kanji.',
